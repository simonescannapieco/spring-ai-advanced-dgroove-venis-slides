    ...
    \begin{minipage}[t]{\textwidth}
        \begin{itemize}[leftmargin=10pt,align=right]
            ...
            \begin{itemize}[leftmargin=10pt,align=right]
                ...
                \onslide<3->\item[\alert{\faExclamationTriangle}] Impensabile pre-addestrare LLM su qualunque sotto-dominio specifico
    ...
    \begin{minipage}[t]{\textwidth}
        \begin{itemize}[leftmargin=10pt,align=right]
            ...
            \begin{itemize}[leftmargin=10pt,align=right]
                ...
                \item[\alert{\faArrowCircleRight}] \ldots
            \end{itemize}
            \onslide<2->\item[\alert{\faArrowCircleRight}] \textit{Data source} SQL/noSQL con interazione \textit{vector data storage}
            \begin{itemize}[leftmargin=10pt,align=right]
