...
%
\begin{frame}[t,fragile] \frametitle{Multimodalità}
    \framesubtitle{Text-to-speech: OpenAI con impostazioni \textit{custom} statiche} 
    {\footnotesize
        \begin{block}{Configurazione applicativo}
			{\tiny\inputminted{yaml}{code/application-tts.yml}}
    	\end{block}    
    }
\end{frame}    
%
...
\begin{frame}[t,fragile] \frametitle{Progetto Spring AI}
    ...
    \begin{itemize}[leftmargin=10pt,align=right]
        ...
        \begin{itemize}[leftmargin=10pt,align=right]
            ...
            \onslide<7->\item[\alertedcircled{6}] Creazione pagina di presentazione
            \onslide<8->\item[\alertedcircled{7}] \textit{Test} delle funzionalità su pagina di presentazione
        \end{itemize}
    \end{itemize}
    }
\end{frame}
