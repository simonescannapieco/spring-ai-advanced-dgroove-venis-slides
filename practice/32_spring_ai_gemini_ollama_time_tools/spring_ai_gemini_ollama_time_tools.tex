\section{\faWrench\ Tool calling\\\small{Concetti base}} % (fold)
\label{sec:spring-tool-calling-base}
%
\begin{frame}[t,fragile] \frametitle{Progetto Spring AI}
    \framesubtitle{Applicazione e passaggi}
    {\small
    \begin{itemize}[leftmargin=10pt,align=right]
        \onslide<1->\item[\alert{\faArrowCircleRight}] Servizio \textit{tool calling} per richiesta ora locale/per fuso orario
        \begin{itemize}[leftmargin=10pt,align=right]
...
\begin{frame}[t,fragile] \frametitle{Progetto Spring AI}
    \framesubtitle{Tool calling}
        \begin{block}{Interfaccia servizio}
			{\tiny\inputminted{java}{code/ToolService.java}}
    	\end{block}
\end{frame}
%
\begin{frame}[t,fragile] \frametitle{Progetto Spring AI}
    ...
    \begin{block}{Implementazione servizio - I}
		{\tiny\inputminted{java}{code/ToolServiceImpl.java}}
    \end{block}
\end{frame}
%
\begin{frame}[t,fragile] \frametitle{Progetto Spring AI}
    ...
    \begin{block}{Implementazione servizio - II}
		{\tiny\inputminted{java}{code/ToolServiceImpl-2.java}}
    \end{block}
\end{frame}
%
\begin{frame}[t,fragile] \frametitle{Progetto Spring AI}
