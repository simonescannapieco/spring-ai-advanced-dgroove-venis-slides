...
\begin{frame}[t,fragile] \frametitle{Spring AI advisors}
    ...
    \begin{itemize}[leftmargin=10pt,align=right]
        ...
        \begin{itemize}[leftmargin=10pt,align=right]
            \onslide<2->\item[\alert{\faArrowCircleRight}] \textit{Logging}
            \begin{itemize}[leftmargin=10pt,align=right]
            ...
            \end{itemize}
            \onslide<3->\item[\alert{\faArrowCircleRight}] Validazione/filtraggio
            \begin{itemize}[leftmargin=10pt,align=right]
            ...
            \end{itemize}
            \onslide<4->\item[\alert{\faArrowCircleRight}] Gestione memoria conversazione
            %\begin{itemize}[leftmargin=10pt,align=right]
            ...
            %\end{itemize}
        \end{itemize}
        \onslide<5->\item[\alert{\faArrowCircleRight}] \textit{Advisor} utente
        \begin{itemize}[leftmargin=10pt,align=right]
            \onslide<6->\item[\alert{\faArrowCircleRight}] Devono implementare \texttt{CallAdvisor} \alert{e/o} \texttt{StreamAdvisor}
        \end{itemize}
    \end{itemize}
    \onslide<7->
