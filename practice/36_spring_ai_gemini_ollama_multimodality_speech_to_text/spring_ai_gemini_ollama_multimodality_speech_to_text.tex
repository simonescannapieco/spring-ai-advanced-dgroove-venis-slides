...
\begin{frame}[t,fragile] \frametitle{Progetto Spring AI}
    ...
    {\small
    \begin{itemize}[leftmargin=10pt,align=right]
        \onslide<1->\item[\alert{\faArrowCircleRight}] Servizio \textit{speech-to-text} Gemini (>= 2.5-flash)
        \begin{itemize}[leftmargin=10pt,align=right]
            \onslide<2->\item[\alertedcircled{1}] Modifica configurazione di sistema
            \onslide<3->\item[\alertedcircled{2}] Creazione interfaccia ed implementazione del servizio
