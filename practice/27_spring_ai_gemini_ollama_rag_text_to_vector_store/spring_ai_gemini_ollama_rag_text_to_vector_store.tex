\section{\faWrench\ Retrieval Augmented Generation\\{\small Parte 1 - Approccio text to vector store}} % (fold)
...
\begin{frame}[t,fragile] \frametitle{Progetto Spring AI}
    ...
    \begin{itemize}[leftmargin=10pt,align=right]
        ...
        \begin{itemize}[leftmargin=10pt,align=right]
            ...
            \onslide<6->\item[\alertedcircled{5}] Modifica configurazione e profilo applicativo
...
\begin{frame}[t,fragile] \frametitle{Progetto Spring AI}
    \framesubtitle{Prompt per strategia RAG - Italiano}
        \begin{block}{\textit{File} \texttt{templates/get-rag-data-system-ita-prompt.st}}
			{\scriptsize\inputminted{text}{code/get-rag-data-system-ita-prompt.st}}
    	\end{block}
        \vspace*{.3cm}
        \begin{block}{\textit{File} \texttt{templates/get-rag-data-system-eng-prompt.st}}
